# Company Packet: State Farm

**Industry:** Insurance + Enterprise Tech  
**Location:** Richardson  
**Career URL:** https://jobs.statefarm.com  
**CI OS Priority Rank:** 33 (Tier 2 - DFW hub / verify sponsorship)  
**Sponsorship Signal:** Large Richardson presence; sponsor verification needed H-1B employer signal confidence 3/5 from sample research — validate per role via DOL LCA data; not legal advice.

---

## Why This Company

State Farm (Richardson): Digital transformation; cloud migration; data-driven operations; cybersecurity. DFW presence supports technology hiring in target role families.
...
|-------|----------|-------------|-----------|
| Data Engineer | Richardson | Cloud / Security / Data / AI / Analyst | — |
| Business Systems Analyst | Richardson | Cloud / Security / Data / AI / Analyst | — |
...
- Signal: Large Richardson presence; sponsor verification needed
...
|------|-------|------|--------------|
| State Farm Careers Recruiting Team | Technology Recruiting | recruiter | source_backed |
...
- https://www.statefarm.com/careers/technology
- https://www.dol.gov/agencies/eta/foreign-labor
- https://www.linkedin.com/search/results/people/?keywords=State%20Farm%20technology%20recruiter%20DFW
