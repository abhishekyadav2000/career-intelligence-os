# Company Packet: BNSF Railway

**Industry:** Transportation + Tech Operations  
**Location:** Fort Worth  
**Career URL:** https://jobs.bnsf.com  
**CI OS Priority Rank:** 28 (Tier 2 - DFW HQ / verify sponsorship)  
**Sponsorship Signal:** DFW HQ; DOL/USCIS validation needed H-1B employer signal confidence 3/5 from sample research — validate per role via DOL LCA data; not legal advice.

---

## Why This Company

BNSF Railway (Fort Worth): Digital transformation; cloud migration; data-driven operations; cybersecurity. DFW presence supports technology hiring in target role families.
...
- Signal: DFW HQ; DOL/USCIS validation needed
...
|------|-------|------|--------------|
| BNSF Railway Careers Recruiting Team | Technology Recruiting | recruiter | source_backed |
...
- https://www.bnsf.com/about-bnsf/technology/
- https://www.dol.gov/agencies/eta/foreign-labor
- https://www.linkedin.com/search/results/people/?keywords=BNSF%20Railway%20technology%20recruiter%20DFW
