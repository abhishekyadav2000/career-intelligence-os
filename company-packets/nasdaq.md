# Company Packet: Nasdaq

**Industry:** Exchange + FinTech  
**Location:** Dallas  
**Career URL:** https://www.nasdaq.com/about/careers  
**CI OS Priority Rank:** 38 (Tier 2 - emerging DFW / verify sponsorship)  
**Sponsorship Signal:** Dallas regional HQ signal; sponsor validation needed H-1B employer signal confidence 3/5 from sample research — validate per role via DOL LCA data; not legal advice.

---

## Why This Company

Nasdaq (Dallas): Digital banking; AI productivity; platform modernization; risk and compliance automation. DFW presence supports technology hiring in target role families.
...
- Signal: Dallas regional HQ signal; sponsor validation needed
...
|------|-------|------|--------------|
| Nasdaq Careers Recruiting Team | Technology Recruiting | recruiter | source_backed |
...
- https://www.linkedin.com/search/results/people/?keywords=Nasdaq%20technology%20recruiter%20DFW
